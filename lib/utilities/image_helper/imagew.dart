...
Future<int> gen(List<String> folders) async {
  ...
  File _file = File('${current.path}/lib/utilities/image_helper/asset_helper.g.dart');
...
Future<void> start() async {
  ...
  List<String> folders = ['icons', 'images', 'images/intro','icons/bank_logo','icons/electric_logo'];
