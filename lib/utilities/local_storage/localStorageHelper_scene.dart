                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            if (textEditingController.text != '') {
                              ...
                              LocalStorageHelper.setInt(
                                      sharedPrefencesKey, value)
                                  .whenComplete(
                                      () => textEditingController.clear());
                            } else {
                              Logger.debug('Input value can not empty');
                            }
                          },
                          child: const Text(
                            'setInt',
                        ...
                        Checkbox(
                            ...
                            onChanged: (value) {
                              setState(() {
                                checkboxValue = value!;
                                LocalStorageHelper.setBool(sharedPrefencesKey, value)
                    ...
                    Row(
                      ...
                      children: [
                          ...
                          onPressed: () async {
                            if (sharedPrefencesKey != '') {
                              final dynamic data = await LocalStorageHelper
                                  .getData(sharedPrefencesKey);
                              setState(() {
                                resultData = data.toString();
                              });
                            } else {
                              Logger.debug('Shared prefences key invalid');
                            }
                          },
                          child: const Text(
                            'Get Data',
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (sharedPrefencesKey != '') {
                              LocalStorageHelper.removeData(
                                      sharedPrefencesKey)
                                  .whenComplete(() => Logger.debug('Removed'));
                            } else {
                              Logger.debug('Shared prefences key invalid');
                            }
                          },
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (textEditingController.text != '') {
                              ...
                              Logger.debug('Input data is empty');
                            }
                          },
                          child: const Text(
                            'Write file',
