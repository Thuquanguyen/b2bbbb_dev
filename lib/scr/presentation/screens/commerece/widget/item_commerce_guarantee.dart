...
class ItemCommerceGuarantee extends StatelessWidget {
  final GuaranteeModel? model;

  const ItemCommerceGuarantee({Key? key, this.model}) : super(key: key);
  ...
  _header() {
    return Container(
      ...
      child: Row(
        children: [
          ImageHelper.loadFromAsset(AssetHelper.icDiamond,
              width: 24, height: 24),
          const SizedBox(
            width: 8,
          ),
      ...
      child: Row(
        ...
        children: [
          itemTextVerticalTitleValue(
            title: AppTranslate.i18n.baoLanhNumberStr.localized,
          ...
          itemTextVerticalTitleValue(
            ...
            value: VpDateUtils.getDisplayDateTime(model?.maturityDate),
            valueStyle: TextStyles.itemText.medium
                .copyWith(color: AppColors.blackTextColor),
          ),
        ],
