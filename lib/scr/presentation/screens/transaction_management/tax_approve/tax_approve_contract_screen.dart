...
class TaxApproveContractScreen extends StatefulWidget {
  const TaxApproveContractScreen({
    Key? key,
  }) : super(key: key);
  static const String routeName = 'TaxApproveContractScreen';

  @override
  State<StatefulWidget> createState() => TaxApproveContractScreenState();
}

class TaxApproveContractScreenState extends State<TaxApproveContractScreen> {
  Uri? path;
  ...
  Widget build(BuildContext context) {
    String contractContent = getArgument<String>(context, 'contractContent') ?? '';

    String contractContentType = getArgument<String>(context, 'contractContentByte') ?? '';
              ...
              children: [
                ...
                Touchable(
                  onTap: () {
                    ...
                    VpFileHelper().actionShareContract(contractContentType, fileNamePrefix: 'TaxRegistration_');
                  },
                  child: Row(
                    children: [
                      Image.asset(
