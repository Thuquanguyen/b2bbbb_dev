...
class ConfigurableExpansionTileCustom extends StatefulWidget {
  ...
  @override
  _ConfigurableExpansionTileCustomState createState() =>
      _ConfigurableExpansionTileCustomState();
}

class _ConfigurableExpansionTileCustomState extends State<ConfigurableExpansionTileCustom>
  ...
  void initState() {
    ...
    _heightFactor = _controller.drive(ConfigurableExpansionTileCustom._easeInTween);
    _iconTurns = _controller.drive(
        (widget.animatedWidgetTurnTween ?? ConfigurableExpansionTileCustom._halfTween)
    ...
    _headerColor = _controller.drive(_headerColorTween.chain(
        widget.headerAnimationTween ?? ConfigurableExpansionTileCustom._easeInTween));
