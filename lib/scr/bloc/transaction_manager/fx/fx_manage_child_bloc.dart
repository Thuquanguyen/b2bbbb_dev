...
class FxManageChildBloc implements TransuctionManageChildBloc {
  @override
  Stream<TransuctionManageState> loadList(
    ...
    try {
      var response = await bloc.transManangerRepository.getTransactionList(
        ...
        TransactionManage.fxCat,
      );

      if (response.result!.isSuccess()) {
        final ListResponse<TransactionMainModel> listTransaction = ListResponse<TransactionMainModel>(
          response.data,
